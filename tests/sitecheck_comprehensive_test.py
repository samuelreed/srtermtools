...
<body>
    ...
    <footer>
        ...
        heavy_content = base_content.replace(
...
class TestSitecheckWithServer(unittest.TestCase):
    ...
    def test_slightly_modified_page(self):
        ...
        self.assertGreaterEqual(similarity, 80, "Slightly modified page should be ≥80% similar")
        self.assertLess(similarity, 100, "Slightly modified page should be <100% similar")
    ...
    def test_moderately_modified_page(self):
        ...
        self.assertGreaterEqual(similarity, 50, "Moderately modified page should be ≥50% similar")
        self.assertLess(similarity, 80, "Moderately modified page should be <80% similar")
    ...
    def test_completely_different_page(self):
        ...
        self.assertLess(similarity, 20, "Completely different page should be <20% similar")
...
class TestSitecheckEdgeCases(unittest.TestCase):
    ...
    def test_unreachable_host(self):
        ...
        # With current implementation, returns (None, None)
        status, hash_value = self.sc.fetch_page("http://this-host-does-not-exist-12345.com")
        self.assertIsNone(status)
        self.assertIsNone(hash_value)
